...
const FoodItem=(
    ...
    return (
        <div className="p-2 bg-red-200 flex rounded-lg flex-col min-h-[360px] min-w-[160px] max-w-[40%] w-[18%] h-[100%] grow shadow-lg m-2 justify-between">
            ...
            <h3 className=" font-normal bg-red-300 w-[auto] p-2 rounded text-sm">Price: Rs. {(+price/100).toFixed(2)}</h3>
